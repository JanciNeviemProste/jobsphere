...
// Every other authenticated mutating route in the app sits behind CSRF; this one
// did not. It reads rather than writes, so the exposure is narrow, but it is the
// endpoint that returns the whole candidate database for a job — it belongs under
